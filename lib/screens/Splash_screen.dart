...
class ssState extends  State<ss>{
  ...
  void initState() {
    super.initState();
      Timer(const Duration(seconds: 2),()=> Navigator.pushReplacement(context,MaterialPageRoute(builder:(context)=> hs())));
  }
  @override
    ...
    return Scaffold(backgroundColor: Theme.of(context).primaryColor,
      body: Column(mainAxisAlignment: MainAxisAlignment.center,
        children: [
         const Center(
            child:
              CircleAvatar(maxRadius: 110,
                backgroundImage: AssetImage("assets/images/pic.jpg")
              )
          ),
          SizedBox.fromSize(size: const Size.square(110)),
          const Text("Muzaffar Mehmood",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 23),
